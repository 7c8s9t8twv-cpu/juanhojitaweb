...
export default function Footer() {
  const social = [
    ...
    { label: 'Instagram', href: 'https://instagram.com/juanhojita_' },
    { label: 'TikTok', href: 'https://www.tiktok.com/@juanhojita' },
    { label: 'X', href: 'https://x.com/juanhojita_' },
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/jtoribiolied/' },
  ];
